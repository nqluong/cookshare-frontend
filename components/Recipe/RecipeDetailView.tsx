...
export default function RecipeDetailView({
  ...
  const [currentAvgRating, setCurrentAvgRating] = useState(
    recipe.averageRating || 0
  );
  const [currentTotalRatings, setCurrentTotalRatings] = useState(
    ...
    return (
      <View style={{ flexDirection: "row", alignItems: "center", gap: 2 }}>
        ...
        {[...Array(emptyStars)].map((_, i) => (
          <Text key={`empty-${i}`} style={{ fontSize: size, color: "#E0E0E0" }}>
            ★
          </Text>
        ))}
      </View>
      ...
      >
          ...
          {difficulty.text && (
            <View
              style={[
                ...
                {
                  backgroundColor: difficulty.color + "33",
                  flexDirection: "row",
                  alignItems: "center",
                  gap: 4,
                },
            ...
            {recipe.category && recipe.category.length > 0 && (
              <View style={styles.tagGroup}>
                {recipe.category.map((cat, index) => (
                  <View
                    key={index}
                    style={[styles.tagItem, { backgroundColor: "#FFF4E6" }]}
                  >
                    <Text style={[styles.tagText, { color: "#FF8C00" }]}>
                      Danh mục {cat}
                    </Text>
                  </View>
                ))}
        ...
        >
          <View style={{ flexDirection: "row", alignItems: "center", gap: 8 }}>
            ...
            <Text style={styles.reportButtonText}>Báo cáo công thức này</Text>
          </View>
        </TouchableOpacity>
      </ScrollView>
