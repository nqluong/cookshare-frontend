...
export default function ProfileScreen() {
  ...
  const renderHeader = () => (
    <>
      ...
      {/* Stats (Đã follow, Follower, Thích) - Chỉnh sửa cho giống ảnh */}
      <View style={styles.statsContainer}>
        ...
        <View style={styles.statItem}>
          <Text style={styles.statNumber}>
            {/* Giả định có một trường likeCount hoặc dùng recipeCount nếu muốn hiển thị số công thức */}
            {formatNumber(userProfile?.recipeCount || 999900)}
          </Text>
